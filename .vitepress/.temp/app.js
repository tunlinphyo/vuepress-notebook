...
import { u as useData$1, i as isExternal, t as treatAsHtml, w as withBase, a as isActive, g as getScrollOffset, o as onContentUpdated, b as inBrowser, c as useRoute, E as EXTERNAL_URL_RE, d as isObject, e as isShell, f as createTitle, m as mergeHead, p as pathToFile, R as RouterSymbol, h as initData, j as dataSymbol, C as Content, s as siteDataRef, k as createRouter } from "./Content.ua2mePAR.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "themed-iframe" }, _attrs))} data-v-91706fb7><div class="themed-iframe__toolbar" aria-label="Preview theme" data-v-91706fb7><!--[-->`);
      ssrRenderList(["system", "light", "dark"], (mode) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "is-active": unref(sharedSettings).theme === mode }, "themed-iframe__toggle"])}" data-v-91706fb7>${ssrInterpolate(mode)}</button>`);
      });
      _push(`<!--]--><div class="blob" data-v-91706fb7></div></div><div class="themed-iframe__frame" style="${ssrRenderStyle({
        width: "100%",
        maxWidth: props.maxWidth,
        height: props.height
      })}" data-v-91706fb7>`);
      if (isLoading.value) {
        _push(`<div class="themed-iframe__loading" role="status" aria-live="polite" aria-busy="true" data-v-91706fb7><span class="themed-iframe__loading-spinner" aria-hidden="true" data-v-91706fb7></span><span class="themed-iframe__loading-text" data-v-91706fb7>Loading preview...</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<iframe class="${ssrRenderClass([{ "is-loading": isLoading.value }, "themed-iframe__element"])}"${ssrRenderAttr("src", props.src)}${ssrRenderAttr("title", props.title)} style="${ssrRenderStyle({
        ...
        margin: "0 auto",
        overflow: "hidden"
      })}" data-v-91706fb7></iframe></div><footer class="themed-iframe__footer" data-v-91706fb7><label class="themed-iframe__switch" data-v-91706fb7><span class="themed-iframe__switch-label" data-v-91706fb7>Layout Borders</span><input${ssrIncludeBooleanAttr(Array.isArray(unref(sharedSettings).layerEnabled) ? ssrLooseContain(unref(sharedSettings).layerEnabled, null) : unref(sharedSettings).layerEnabled) ? " checked" : ""} type="checkbox" class="themed-iframe__switch-input" data-v-91706fb7><span class="themed-iframe__action-toggle" aria-hidden="true" data-v-91706fb7></span></label></footer><div class="source-code-link" data-v-91706fb7><a${ssrRenderAttr("href", `https://github.com/tunlinphyo/vuepress-notebook/blob/main/public${_ctx.$props.src}`)} target="_blank" rel="noopener noreferrer" data-v-91706fb7>Open Source Code</a></div></div>`);
    };
  }
});
...
const ThemedIframe = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-91706fb7"]]);
const _sfc_main$1 = {
  __name: "AdsenseBlock",
  __ssrInlineRender: true,
  setup(__props) {
